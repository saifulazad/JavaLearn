...
public class MyFunctionEx {
     ...
     * having no parameter and no return type
     *
     * return_type   void
     * function_name myfirstfunction
     * parameter list : blank / no parameter that means ()
     */
    ...
    public static void main(String[] args){
        /**
         * Now this program has no output
         *
         * call myfirstfunction function from main
         * by myfirstfunction
         */
